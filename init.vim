...
"telescope dependencie: BurntSushi/rip/grep (is required for live_grep and
"grep_string:  sudo pacman -S ripgrep (IN TERMINAL)

"telescope dependecie: Sharkpd/fd (IN TERMINAL) : sudo pacman -S fd

"telescope dependecie: Treesitter
...
" status Bar Lightline prueba end
